...
let largest = cloneNumbers.sort((a, b) => a -b).pop();

// - Find longest string in strings

let longest = cloneStrings.sort((a, b) => a.length - b.length).pop();

// - Find all the even numbers
let filterEven = cloneNumbers.filter((num) => num % 2 === 0);

// - Find all the odd numbers

let filterOdd = cloneNumbers.filter((num) => num % 2 !== 0);
...
let strLength = cloneStrings.map((string) => string.length);
